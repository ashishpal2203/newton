...
<style>
    /* Make the quill editor taller inside the AdminLTE card */
    #editor-container {
        height: 400px;
    }
</style>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-4">
                                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                    ...
                                    <label class="custom-control-label" for="is_published">Publish this page immediately</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" value="{{ old('slug') }}" placeholder="leave-blank-to-auto-generate">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="meta_description" class="form-control @error('meta_description') is-invalid @enderror" id="meta_description" rows="4" placeholder="Brief description for search engines">{{ old('meta_description') }}</textarea>

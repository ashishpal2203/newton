@extends('layouts.app')
@section('title', "About Newton's Academy | Leading Coaching Classes in Mulund")

@section('meta_description', 'Learn about Newton\'s Academy, Zaver Road, Mulund West - our vision, mission, expert IIT/Medical faculty, study library, and champion student testimonials.')
@section('meta_keywords', 'About Newtons Academy, Newtons Academy Mulund, IIT Coaching Mulund, Medical Entrance Coaching Mulund, Zaver Road classes')
...
<!-- Semantic H1 for SEO -->
<h1 class="visually-hidden">About Newton's Academy - Leading Coaching Institute in Mulund West</h1>
...
<section>
  ...
  <div class="about-hero-bg">
    ...
    <img src="{{ Storage::url('assets/images/about-us-header.jpeg') }}" alt="Newton's Academy Students in Classroom Study" title="About Newton's Academy">
  </div>
  ...
  <div class="row g-4">
      ...
      <div class="card h-100 border-0 shadow-lg rounded-4 p-4">
        <div class="d-flex align-items-center gap-3 mb-3">
          <div class="vm-icon">
            ...
            <img src="{{ Storage::url('assets/images/my1.png') }}" alt="Newton's Academy Vision Icon">
          </div>
    ...
    <div class="col-md-6">
      <div class="card h-100 border-0 shadow-lg rounded-4 p-4">
        <div class="d-flex align-items-center gap-3 mb-3">
          <div class="vm-icon">
             <img src="{{ Storage::url('assets/images/my2.png') }}" alt="Newton's Academy Mission Icon">
          </div>
    ...
    <div class="why-choose-wrap">
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="why-card">
            <span class="why-icon">
               <img src="{{ Storage::url('assets/images/111.png') }}" alt="Top-Tier Faculty Icon">
             </span>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="why-card">
            <span class="why-icon">
             <img src="{{ Storage::url('assets/images/222.png') }}" alt="Tailored Study Material Icon">
           </span>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="why-card">
            <span class="why-icon">
             <img src="{{ Storage::url('assets/images/333.png') }}" alt="Individualized Focus Icon">
           </span>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="why-card">
            <span class="why-icon"> 
              <img src="{{ Storage::url('assets/images/444.png') }}" alt="Regular Tests Icon">
            </span>
            <h6>Regular Tests</h6>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="why-card">
            <span class="why-icon">
             <img src="{{ Storage::url('assets/images/555.png') }}" alt="Library Facility Icon">
           </span>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="why-card">
            <span class="why-icon">
             <img src="{{ Storage::url('assets/images/666.png') }}" alt="Parental Updates Icon">
                ...
                <div class="champion-card">
                    <div class="champion-header">
                        @if($review->user_image)
                            <img src="{{ Storage::url($review->user_image) }}" alt="Champion Student {{ $review->user_name }}" title="{{ $review->user_name }} Success Story">
                        @else
